...
def manage_resources(setup_kwargs: Any) -> Any:
    ...
    skip_nodeenv = os.environ.get("LITESTAR_SKIP_NODEENV_INSTALL") is not None or NODEENV_INSTALLED is False
    ...
    if platform.system() == "Windows":
        kwargs["shell"] = True
    if package_json_exists and install_packages is not None:
        logger.info("Installing NPM packages.")
        subprocess.run(["npm", "install"], **kwargs)  # noqa: S607, PLW1510
    if package_json_exists and  build_assets is not None:
